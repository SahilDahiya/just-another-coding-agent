...
type Backend interface {
	...
	PollOpenAICodexLogin(ctx context.Context, flowID string) (rpc.AuthLoginOpenAICodexPollResponse, error)
	StartGitHubCopilotLogin(ctx context.Context, enterpriseDomain string) (rpc.AuthLoginGitHubCopilotStartResponse, error)
	PollGitHubCopilotLogin(ctx context.Context, flowID string) (rpc.AuthLoginGitHubCopilotPollResponse, error)
