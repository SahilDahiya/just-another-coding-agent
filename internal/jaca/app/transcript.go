...
func (t *Transcript) WriteHelp() {
	t.WriteNote("commands", []string{
		...
		"  /provider openrouter                 select OpenRouter, auth starts if needed",
		"  /provider anthropic                  select Anthropic, auth starts if needed",
		"  /provider google                     select Google Gemini, auth starts if needed",
		"  /auth ollama                         save Ollama cloud API key securely",
		"  /auth openai                         save OpenAI API key securely",
		"  /auth openrouter                     save OpenRouter API key securely",
		"  /auth anthropic                      save Anthropic API key securely",
		"  /auth google                         save Google API key securely",
