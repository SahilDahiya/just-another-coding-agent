...
{"type":"session_turn_context","run_id":"abc","model":"openai-responses:gpt-5.3-codex","thinking":"high","workspace_root":"/abs/path/to/workspace","shell_family":"posix","current_date":"2026-04-03","runtime_context_text":"Current date: 2026-04-03\nCurrent workspace root: /abs/path/to/workspace\nCurrent shell family: posix (bash)"}
