...
- MCP architecture, Code Mode routing, and onboarding-as-MCP direction: [mcp.md](mcp.md)
...
- [mcp.md](mcp.md) - MCP architecture, Code Mode routing, and onboarding-as-MCP direction
